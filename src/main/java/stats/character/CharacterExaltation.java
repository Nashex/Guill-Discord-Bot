...
public class CharacterExaltation {
    ...
    public CharacterExaltation(String characterName, String[] data, int numExaltations) {
        ...
        Guild CHAR_EMOTE_SERVER = Guill.jda.getGuildById("767811138905178112");
        ...
        for (int i = 0; i < 8; i++) {
            ...
            exaltationEmotes[i] = Guill.jda.getEmotesByName(HEADERS[i] + (i < 2 ? exaltationData[i] / 5 : exaltationData[i]), true).get(0);
        }
    }
}
